...
public class TpDenyCommand implements CommandExecutor, TabCompleter {
    ...
    public TpDenyCommand(EvaulxCore plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (requester != null) requester.sendMessage(CC.color("&f" + target.getName() + " &cdenied your teleport request."));
        target.sendMessage(CC.color("&7Teleport request denied."));
        return true;
    }
